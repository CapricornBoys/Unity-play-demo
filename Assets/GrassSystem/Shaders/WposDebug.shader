Shader "Custom/WposDebug"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // WORDPOS DEBUG: show world position as color
            half4 frag(G i) : SV_Target
            {
                // Normalize world XZ from -10..+10 to 0..1
                // If world pos is correct, grass will show red-green gradient
                float2 uv = (i.w.xz - float2(-10, -10)) / float2(20, 20);
