// GrassTrailShader.shader - DEBUG: red where trail > 0

Shader "Custom/GrassTrailShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // DEBUG: Sample trail RT and turn red where trail exists
                ...
                if (trail > 0.05)
                {
                    // Debug: bright red where trail exists
