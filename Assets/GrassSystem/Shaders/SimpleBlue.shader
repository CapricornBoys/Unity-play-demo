Shader "Custom/SimpleBlue"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Trail: sample _TrailTex and VISUALIZE tr value as color
            half4 frag(G i) : SV_Target
            {
                ...
                // VISUALIZE: tr as red channel, uv.x as green, uv.y as blue
                // If tr=0 → black; tr>0 → red; uv varies → green/blue
                return half4(tr, tuv.x, tuv.y, 1.0);
            }
            ENDHLSL
        }
    }
